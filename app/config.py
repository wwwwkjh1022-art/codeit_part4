...
class Settings(BaseSettings):
    ...
    openai_request_timeout_seconds: int = 15
    ...
    naver_blog_headless: bool = True
    naver_blog_slowmo_ms: int = 0
    naver_blog_timeout_ms: int = 45000
    naver_blog_connect_timeout_seconds: int = 300
    sd35_api_key: str | None = None
    sd35_endpoint_url: str | None = None
    sd35_model: str = "stabilityai/sdxl-turbo"
    sd35_width: int = 1024
    sd35_height: int = 768
    sd35_steps: int = 4
    sd35_guidance_scale: float = 2.0
